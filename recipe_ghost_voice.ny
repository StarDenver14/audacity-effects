...
;version 4
;type process
;name "Ghost Voice Recipe"
;action "Applying ghost voice recipe effect..."
;author "Audacity Plugin"
;copyright "Public Domain"
;info "Whisper, pre-echo, and rumble combined."
...
(let* ((t (/ intensity 100.0))
       (breath (mult (highpass2 (noise (get-duration 1)) 4000) (* t comp1)))
       (pre (mult (delay *track* 0.06) (* t comp2)))
       (rum (mult (osc (hz-to-step 50)) (* t comp3 0.2)))
