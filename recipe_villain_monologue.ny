...
;version 4
;type process
;name "Villain Monologue Recipe"
;action "Applying villain monologue recipe effect..."
;author "Audacity Plugin"
;copyright "Public Domain"
;info "Dark villain tone with precision and cathedral space."
...
(let* ((t (/ intensity 100.0))
       (dark (lowpass2 *track* (lerp 20000 1800 (* t comp1))))
       (clean (soft-clip dark (* t comp2 0.2)))
       (space (add-echo clean (lerp 0.06 0.14 (* t comp3)) (lerp 0.2 0.7 (* t comp3))))
