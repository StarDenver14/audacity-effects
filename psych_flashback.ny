...
;type process
;name "Flashback"
;action "Applying flashback effect..."
;author "Audacity Plugin"
;copyright "Public Domain"
;info "Distant, hazy memory quality."

;control intensity "Effect Intensity" real "%" 50 0 100
;control telephone "Telephone Filter" real "" 0.5 0 1
;control reverb "Heavy Reverb" real "" 0.6 0 1
;control distance "Distant Quality" real "" 0.4 0 1
...
(let* ((t (/ intensity 100.0))
       (bp (safe-bandpass *track* (lerp 20 400 (* t telephone)) (lerp 20000 2500 (* t telephone))))
       (room (add-echo bp (lerp 0.04 0.12 (* t reverb)) (lerp 0.2 0.6 (* t reverb))))
       (lp (lowpass2 room (lerp 20000 1800 (* t distance))))
       (gain (lerp 1.0 0.8 (* t distance)))
       (wet (mult lp gain))
       (out (mix *track* wet t)))
  out)
