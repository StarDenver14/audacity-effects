...
;type process
;name "Tiny"
;action "Applying tiny effect..."
;author "Audacity Plugin"
;copyright "Public Domain"
;info "Bright, small voice with higher pitch."

;control intensity "Effect Intensity" real "%" 50 0 100
;control pitch "Pitch Shift (semitones)" real "st" 12 6 18
;control room "Room Size" real "" 0.2 0 1
;control formant "Formant Shift" real "" 0.5 0 1
...
(let* ((t (/ intensity 100.0))
       ...
       (bright (highpass2 pitched (lerp 80 800 (* t formant))))
       (roomy (add-echo bright (lerp 0.01 0.03 (* t room)) (lerp 0.1 0.4 (* t room))))
       (out (mix *track* roomy t)))
  out)
