...
;version 4
;type process
;name "Secret Agent Recipe"
;action "Applying secret agent recipe effect..."
;author "Audacity Plugin"
;copyright "Public Domain"
;info "Radio DJ, inner monologue, and small room combined."
...
(let* ((t (/ intensity 100.0))
       (dj (soft-clip *track* (* t comp1 0.3)))
       (inner (lowpass2 dj (lerp 20000 2000 (* t comp2))))
       (room (add-echo inner (lerp 0.02 0.05 (* t comp3)) (lerp 0.1 0.4 (* t comp3))))
