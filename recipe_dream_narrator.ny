...
;version 4
;type process
;name "Dream Narrator Recipe"
;action "Applying dream narrator recipe effect..."
;author "Audacity Plugin"
;copyright "Public Domain"
;info "Dream voice, inner monologue, and cathedral space."
...
(let* ((t (/ intensity 100.0))
       (dream (lowpass2 (resample *track* (lerp 1.0 0.85 (* t comp1))) 1500))
       (intimate (lowpass2 dream (lerp 20000 1200 (* t comp2))))
       (space (add-echo intimate (lerp 0.07 0.15 (* t comp3)) (lerp 0.2 0.6 (* t comp3))))
