...
;version 4
;type process
;name "Underwater Communication Recipe"
;action "Applying underwater communication recipe effect..."
;author "Audacity Plugin"
;copyright "Public Domain"
;info "Underwater, walkie-talkie, and distant combined."
...
(let* ((t (/ intensity 100.0))
       (under (lowpass2 (resample *track* (lerp 1.0 0.85 (* t comp1))) 900))
       (radio (safe-bandpass under 300 2800))
       (dist (mult radio (lerp 1.0 0.7 (* t comp3))))
       (wet (mix under dist (* t comp2)))
       (out (mix *track* wet t)))
  out)
