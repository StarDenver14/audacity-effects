...
;version 4
;type process
;name "Haunted Recording Recipe"
;action "Applying haunted recording recipe effect..."
;author "Audacity Plugin"
;copyright "Public Domain"
;info "Vinyl noise, ghost voice, and through-wall combined."
...
(let* ((t (/ intensity 100.0))
       (vinyl (sum *track* (mult (noise (get-duration 1)) (* t comp1 0.03))))
       (ghost (sum vinyl (mult (delay vinyl 0.06) (* t comp2))))
       (muffled (lowpass2 ghost (lerp 20000 1800 (* t comp3))))
